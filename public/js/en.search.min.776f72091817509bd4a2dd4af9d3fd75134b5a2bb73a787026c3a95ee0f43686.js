...
function init(){input.removeEventListener('focus',init);loadScript('/js/groupBy-174feb11c7.min.js');loadScript('/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/en.search-data.min.json"
